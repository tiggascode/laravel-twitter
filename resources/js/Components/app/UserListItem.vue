    ...
    <div
        ...
        <div class="flex items-center gap-2 py-2 px-2">
            ...
            <div class="flex justify-between flex-1">
                ...
                <div v-if="forAprrove" class="flex gap-1">
                    <button
